...
public class AppDbContextFactory : IDesignTimeDbContextFactory<AppDbContext>
{
    public AppDbContext CreateDbContext(string[] args)
    {
        ...
        optionsBuilder.UseNpgsql(
            "Host=aws-1-ap-southeast-2.pooler.supabase.com;Port=6543;Database=postgres;Username=postgres.yhmjqlxtthzherewwbiy;Password=190501.Emirr;SSL Mode=Require;Trust Server Certificate=true",
